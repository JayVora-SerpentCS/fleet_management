...
class NextServiceByOdometer(ReportXlsx):
...
#        worksheet.merge_range('C3:I3', 'Merged Cells', merge_format)
...
NextServiceByOdometer('report.next.services.by.odometer.xls', 'fleet.vehicle')
