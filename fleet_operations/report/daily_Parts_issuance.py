        ...
        for obj in parts_data:
            for line in obj.parts_ids:
                ...
                worksheet.write(
                    line_row,
                    line_col,
                    line.fleet_service_id and line.fleet_service_id.name or "",
                    border,
                )
                line_col += 1
                worksheet.write(
                    line_row,
                    line_col,
                    line.fleet_service_id
                    and line.fleet_service_id.vehicle_id
                    and line.fleet_service_id.vehicle_id.name
                    or "",
                    border,
                )
                line_col += 1
                ...
                line_col += 1
                worksheet.write(line_row, line_col, line.qty or "", border)
                line_col += 1
                worksheet.write(
                    line_row,
                    line_col,
                ...
                line_col += 1
                worksheet.write(line_row, line_col, line.old_part_return or "", border)
                line_col += 1
                worksheet.write(
                    line_row,
                    line_col,
                    line.issued_by and line.issued_by.name or "",
                    border,
                )
                line_col += 1
                worksheet.write(
                    line_row,
                    line_col,
                    line.fleet_service_id and line.fleet_service_id.note or "",
                    border,
                )
                line_col = 0
                line_row += 1
