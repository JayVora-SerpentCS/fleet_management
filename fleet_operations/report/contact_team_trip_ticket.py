    ...
    def generate_xlsx_report(self, workbook, data, trip_ticket):
        ...
        for obj in trip_ticket:
            ...
            worksheet.write(
                row,
                3,
                obj.destination_location_id and obj.destination_location_id.name or "",
            )
            ...
            if obj.allocate_part_ids:
                for line in obj.allocate_part_ids:
                    ...
                    line_col += 1
                    worksheet.write(line_row, line_col, line.name or "", border)
                    line_col += 1
                    worksheet.write(
                        line_row,
                        line_col,
                        line.vehicle_make_id and line.vehicle_make_id.name or "",
                        border,
                    )
                    line_col += 1
                    worksheet.write(
                        line_row,
                        line_col,
                        line.product_id.uom_id and line.product_id.uom_id.name or "",
                        border,
                    )
                    line_col += 1
                    worksheet.write(line_row, line_col, line.qty_on_truck or "", border)
                    line_col += 1
                    worksheet.write(line_row, line_col, line.qty_used or "", border)
                    line_col += 1
                    worksheet.write(line_row, line_col, line.qty_missing or "", border)
                    line_col += 1
                    worksheet.write(line_row, line_col, line.qty_damage or "", border)
                    line_col += 1
                    worksheet.write(
                        line_row, line_col, line.qty_remaining or "", border
                    )
                    line_col += 1
                    ...
                    worksheet.write(line_row, line_col, None, border)
                    line_col += 1
                    worksheet.write(line_row, line_col, line.remark or "", border)
                    line_col = 0
                    line_row += 1
                    counter += 1
            ...
            worksheet.write(row, 1, obj.prepairdby_id and obj.prepairdby_id.name or "")
            row += 2
