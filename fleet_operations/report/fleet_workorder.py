                ...
                if work_rec.state and work_rec.state == "done":
                    ...
                    if wo_smry_dict.get(work_rec.team_id.id, False):
                        ...
                        wo_data = {
                            ...
                            "etic": work_rec.etic and work_rec.date_complete or "",
                        ...
                        wo_smry_dict[work_rec.team_id.id] = {
                            "team_id": work_rec.team_id and work_rec.team_id.name or "",
                            "value": [wo_data],
                        }
        for _team_id, workorder_data in wo_smry_dict.items():
    ...
    def generate_xlsx_report(self, product):
        ...
        for obj in self.get_wo_smry(product):
            for line in obj.get("value"):
                ...
                line_col += 1
                worksheet.write(line_row, line_col, line.get("name") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("identification") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("vin") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("date_open") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("state") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("etic") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("date_close") or "")
                line_col += 1
                worksheet.write(line_row, line_col, obj.get("team_id") or "")
                line_col += 1
                worksheet.write(line_row, line_col, line.get("work_performed") or "")
                line_col = 0
                line_row += 1
                counter += 1
