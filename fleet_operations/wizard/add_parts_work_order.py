...
class add_parts_work_order(models.TransientModel):
    ...
    def onchange_product_id(self):
        ...
        if self.product_id:
            ...
            if self._context.get('team_id', False):
                ...
                if team_trip_ids:
                    ...
                    if rec.qty_available <= 0:
                        raise Warning("User Error!", _("You can\'t \
                                    select part \
                ...
                if rec.qty_available < self.used_qty:
                    raise Warning("User Error!", _("You can\'t enter \
            ...
            self.dummy_vehicle_make_id = rec.vehicle_make_id \
                and rec.vehicle_make_id.id or False
